...
# def get_order_cash(ord_dv, itm_no, qty, unpr, tr_cont, FK100="", NK100="", dataframe=None):  # 국내주식주문 > 주식주문(현금)
...
# Input: None (Option) 상세 Input값 변경이 필요한 경우 API문서 참조
# Output: DataFrame (Option) output
def get_inquire_daily_itemchartprice(div_code, itm_no, tr_cont, inqr_strt_dt, inqr_end_dt, period_code, adj_prc, FK100="", NK100="", dataframe=None):  # [국내주식] 기본시세 > 국내주식기간별시세(일/주/월/년)
